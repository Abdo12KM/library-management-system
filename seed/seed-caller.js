...
if (process.argv[2] == "--seed-all") {
  ...
  console.log("Usage:");
  console.log(
    "  --seed-all                     Seed all data in correct order",
  );
  console.log("  --delete-all                   Delete all data");
  console.log(
    "  --import <model>               Import data for specific model",
  );
  console.log(
    "  --delete <model>               Delete data for specific model",
  );
  console.log("");
  console.log(
    "Available models: readers, authors, publishers, staff, books, loans, fines",
  );
}
