...
const { getAllFines, createFine, payFine, createFinesForOverdueLoans } = require("../controllers/fineController");
...
fineRouter.post("/create-overdue", protect, restrictTo("admin", "librarian"), createFinesForOverdueLoans);
