...
const { getAllReaders, getReaderById, deleteReader, getMe, updateMe, updateMyPassword } = require("../controllers/readerController");
...
readerRouter.get("/:id", protect, restrictTo("admin", "librarian"), getReaderById);
